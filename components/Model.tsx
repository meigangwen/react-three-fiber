...
export default function Model(){
    const { x,y,z,visible,color,metalness,roughness,clearcoat, clearcoatRoughness,transmission,ior,thickness } = useControls("Monkey", {
        ...
        transmission: { value:0, min:0, max:1.0, step: 0.01},
        ior: { value:1.74, min:1, max:5.0, step: 0.01},
        thickness: { value:3.12, min:0, max:5.0, step: 0.01}
    }
